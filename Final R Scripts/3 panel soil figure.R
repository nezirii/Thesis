...
ggplot(data=x, 
  ...
  #xlab("Sample Event") +
  ylab(expression(Soil~Ammonium~(µg~N~g^{-1}))) +
...
ggplot(data=x, 
  ...
  #xlab("Sample Event") +
  ylim(-2.5,16) +
  ylab(expression(Soil~Nitrate~(µg~NO[3]~-N~g^{-1}~soil))) +
  labs(fill="Budworm Activity") +
