...
plot(x=cr$total.water.l, y=cr$rate.of.decomposition, xlab="L H2O", ylab="Rate of Coniferous Decomposition")

cor(cr$total.water.l, cr$rate.of.decomposition)

M0<-lm(rate.of.decomposition ~ total.water.l, data=cr)
...
tiff(filename = 'figures/Conifer Water Reg.tiff', #open plotting device
     width = 6.5,
     height = 6.0,
     units = "in",
     res = 1200,
...
tiff(filename = 'figures/Conifer DIN Reg.tiff', #open plotting device
     width = 6.5,
     height = 6.0,
     units = "in",
     res = 1200,
